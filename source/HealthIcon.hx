...
class HealthIcon extends FlxSprite
{
	...
	public function changeIcon(char:String) {
		if(this.char != char) {
			...
			if(!Paths.fileExists('images/' + name + '.png', IMAGE)) name = 'icons/' + char + '-icons'; //Older versions of psych engine's support
			if(!Paths.fileExists('images/' + name + '.png', IMAGE)) name = 'icons/face-icons'; //Prevents crash from missing icon
