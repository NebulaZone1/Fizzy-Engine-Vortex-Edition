...
{
	public static var fizzyEngineVersion:String = '0.1.1'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(FlxG.width * 0.7, FlxG.height - 44, 0, "Fizzy Engine: Vortex Edition v" + fizzyEngineVersion, 12);
